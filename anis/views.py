...
from khoiriyah.models import Transaksi, DetailTransaksi
...
from khoiriyah.forms import KhoiriyahAddProductForm
from khoiriyah.keranjang import Khoiriyah
import datetime
...
def beranda(request):
    ...
    khoiriyah_product_form = KhoiriyahAddProductForm()
    context = { "judul": "Halaman Beranda",
                "kategori" : kategori, 
                "jumlahkategori":jumlahkategori,
                "slide": slider,
                "trending":trending,
                "khoiriyah_product_form": khoiriyah_product_form,
...
class KontakView(View):
    ...
    def post(self, request):
        ...
        kontak = Kontak.objects.create(nama = nama, email = email, no_whatsApp=no_whatsup, subject = subject, isi = pesan )
        kontak.save()
        context = {
                    'judul': 'Halaman Kontak',
                    'data': "",
